...
if __name__ == '__main__':
    ...
    for dataset_name in dataset_list:
        ...
        num_pc25_5 = num_pc25_10 = num_pc25_15 = 0

        # Partial match counters (threshold=0.50)
        num_pc50_5 = num_pc50_10 = num_pc50_15 = 0
        ...
        for pred_list, label_list in zip(preds, labels): 
            ...
            num_pc25_15 += count_word_overlap_matches(pred_s_list[:15], pred_set_list[:15], label_s_list, label_list, threshold=0.25)
            # ==================================================================
            ...
            num_pc50_15 += count_word_overlap_matches(pred_s_list[:15], pred_set_list[:15], label_s_list, label_list, threshold=0.50)
            # ==================================================================
        ...
        p_pc25_15, r_pc25_15, f_pc25_15 = get_PRF(num_pc25_15, num_e_15, num_s)
        print_PRF(p_pc25_15, r_pc25_15, f_pc25_15, 15)

        f_pc25_5_scores.append(f_pc25_5*100)
        f_pc25_10_scores.append(f_pc25_10*100)
        f_pc25_15_scores.append(f_pc25_15*100)
        ...
        p_pc50_15, r_pc50_15, f_pc50_15 = get_PRF(num_pc50_15, num_e_15, num_s)
        print_PRF(p_pc50_15, r_pc50_15, f_pc50_15, 15)

        f_pc50_5_scores.append(f_pc50_5*100)
        f_pc50_10_scores.append(f_pc50_10*100)
        f_pc50_15_scores.append(f_pc50_15*100)
    ...
    logging.info("Exact Match F1@15 Scores by Dataset: " + "\t".join(f"{f:.2f}" for f in f_15_scores))
    logging.info("Exact Match Average F1@15 Score: " + f"{avg_f_15:.2f}")
    ...
    avg_f_pc25_15 = sum(f_pc25_15_scores) / len(f_pc25_15_scores)
    logging.info("Partial Match (0.25) F1@15 Scores by Dataset: " + "\t".join(f"{f:.2f}" for f in f_pc25_15_scores))
    logging.info("Partial Match (0.25) Average F1@15 Score: " + f"{avg_f_pc25_15:.2f}")
    ...
    avg_f_pc50_15 = sum(f_pc50_15_scores) / len(f_pc50_15_scores)
    logging.info("Partial Match (0.50) F1@15 Scores by Dataset: " + "\t".join(f"{f:.2f}" for f in f_pc50_15_scores))
    logging.info("Partial Match (0.50) Average F1@15 Score: " + f"{avg_f_pc50_15:.2f}")